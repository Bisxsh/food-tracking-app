          ...
          >
            ...
            >
              <Picker.Item
                ...
                value="Ingredient"
                style={{
                  color: isDarkMode ? COLOURS.textTouchable : COLOURS.black,
                }}
              />
              <Picker.Item
                label="Category"
          ...
          >
            <Pressable
              ...
              onPress={async () => {
                ...
                for (
                  let index = 0;
                  index < Dummy.DUMMY_CATEGORIES.length;
                  index++
                ) {
                  await DB.create(
                    new Category(
                ...
                for (let i = 0; i < 100; i++) {
                  ...
                  date.setMonth(
                    (date.getMonth() -
                      Math.floor(c / 2) +
                      12 * (Math.floor(c / 12) + 1)) %
                      12
                  );
                  date.setFullYear(
                    date.getFullYear() -
                      Math.floor(
                        (Math.floor(c / 2) + 11 - date.getMonth()) / 12
                      )
                  );
                ...
                setUserData({
                  ...userData,
                  ingredientCategories: user.categories.map((v) =>
                    v.toCategoryClass()
                  ),
              ...
              onPress={() => {
                switch (selectedTable) {
                  ...
                  case "History":
                    ...
                    date.setFullYear(
                      date.getFullYear() -
                        Math.floor(Math.floor(monthCount / 2) / 12)
                    );
                    const newHistory = new History(
                      0,
                      date,
