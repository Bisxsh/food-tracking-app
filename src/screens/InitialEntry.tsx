...
import {StyleSheet, View, Text, TextInput, TouchableOpacity, ScrollView, Alert, AlertButton, Image, Button, Pressable} from 'react-native';
...
export function InitialEntry(prop: InitialEntryProp): JSX.Element{
    ...
    const dietReqRows: JSX.Element[] = prop.user.dietReq.map((value, index)=>{
            ...
            return <SelectRow
                ...
                text={value[0]}
                initialVal={value[1]}
                onChange={(newValue:boolean)=>selectRowOnChange(newValue, value[0], prop.user, prop.setUser)}
            />
        }
    )
    ...
    return (
        ...
        >
            ...
            >
                {img != undefined && <TouchableOpacity onPress={()=>{getPhoto(showActionSheetWithOptions, prop.user, prop.setUser, setImg)}}>
                    <Image
                        style={{
                            alignItems: "center",
                            aspectRatio: 1,
                ...
                >
                    <Checkbox
                        onPress={(value)=>{prop.user.consent = value}}
                    ...
                    <Text
                        style={{flexShrink: 1}}
                    >
                        By check this, you are comfirming that your information is stored in this app securely, and used only for improving your experience.
                    </Text>
                </View>
                <Pressable
